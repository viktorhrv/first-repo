...
public class PlayingWindow extends javax.swing.JFrame {
    ...
    public PlayingWindow() {
        ...
        String name = JOptionPane.showInputDialog(this, "Въведете име!");
        Pattern regex = Pattern.compile("\\w+");
        Matcher regexm = regex.matcher(name);
        System.out.println(regexm);

        if (regexm.matches() == true) {
            name1 = name;
            
        } else {
            while(regexm.matches() == false){    
                name = JOptionPane.showInputDialog(this, "Въведете име!");
                regexm = regex.matcher(name);
                if (regexm.matches() == true) {
                name1 = name;
                }
        }
    ...
    private void takeCardBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_takeCardBtnActionPerformed
        ...
        if (playerResult > 21) {
            ...
            try (
                     FileWriter fileWriter = new FileWriter("//src//Result.txt", true);  PrintWriter printWriter = new PrintWriter(fileWriter)) {
    ...
    private void stopBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_stopBtnMouseClicked
        ...
        if (dealerHandValue > 21) {
            ...
            try ( FileWriter fileWriter = new FileWriter("E:\\Java\\first-repo\\first-repo\\first-repo\\src\\Result.txt", true);  PrintWriter printWriter = new PrintWriter(fileWriter)) {
